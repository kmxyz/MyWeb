                    ...
                    <div className="col">
                        <div className='text-start'>
                            ...
                            <p style={this.state.pStyle}>
                                Hi, I am Mark Xiao and I am from China. I recently graduated from Dal 
                    ...
                    <div className="col" style={{marginTop : "30px"}}>
                        <div className='text-start'>
                            ...
                            <div className="row row-cols-2">
                                {this.state.infoElement.map(x => (<div className="col" style={this.state.pInfoStyle}><h5>{x[0]} : </h5><p>{x[1]}</p></div>))}
                            </div>
                        </div>
                    </div>
                </div>
